...
def post_install(self):
    ...
    # rename config files
    self.rename("usr/share/examples/ups/nut.conf.sample", "nut.conf")
    self.rename("usr/share/examples/ups/ups.conf.sample", "ups.conf")
    self.rename("usr/share/examples/ups/upsd.conf.sample", "upsd.conf")
    self.rename("usr/share/examples/ups/upsd.users.sample", "upsd.users")
    self.rename("usr/share/examples/ups/upsmon.conf.sample", "upsmon.conf")
    self.rename("usr/share/examples/ups/upssched.conf.sample", "upssched.conf")
